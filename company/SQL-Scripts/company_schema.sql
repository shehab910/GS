...
ALTER TABLE
    "students_departments" ADD CONSTRAINT "students_departments_student_id_foreign" FOREIGN KEY("student_id") REFERENCES "students"("id");
ALTER TABLE
    "students_departments" ADD CONSTRAINT "students_departments_department_id_foreign" FOREIGN KEY("department_id") REFERENCES "departments"("id");